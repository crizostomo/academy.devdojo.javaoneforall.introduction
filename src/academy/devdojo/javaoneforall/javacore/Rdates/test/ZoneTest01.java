...
public class ZoneTest01 {
    public static void main(String[] args) {
        ...
        JapaneseDate japanaseDate = JapaneseDate.from(LocalDate.now());
        JapaneseDate japanaseDate2 = JapaneseDate.from(LocalDate.of(1900, Month.JANUARY, 1));
        System.out.println(japanaseDate);
        System.out.println(japanaseDate2);
