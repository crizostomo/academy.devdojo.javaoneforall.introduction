...
//281 - Unit tests with jUnit pt 02
...
//        Assertions.assertEquals(false, personService.isAdult(person));
    ...
    @Test
    @DisplayName("A person should be adult if older or equal 18")
    void isAdult_ReturnTrue_WhenAgeIsGreaterOrEqual18() {
    ...
    void filterRemovingNotAdult_RemoveNonAdultsFromList_WhenListWithPersonIsPassed() {
        ...
        Assertions.assertEquals(2, personService
                .filterRemovingAdult(personList).size());
